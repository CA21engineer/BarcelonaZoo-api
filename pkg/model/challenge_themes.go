...
var (
	challengeThemeAllColumns            = []string{"id", "title", "description", "user_id", "recordable", "is_int", "unit", "ranking_type", "created_at"}
	challengeThemeColumnsWithoutDefault = []string{"title", "description", "user_id", "recordable", "is_int", "unit", "ranking_type", "created_at"}
...
func (challengeThemeL) LoadChallengeRecords(ctx context.Context, e boil.ContextExecutor, singular bool, maybeChallengeTheme interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		...
		qm.WhereIn(`challenge_records.challenge_theme_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (challengeThemeL) LoadThemeTagRelations(ctx context.Context, e boil.ContextExecutor, singular bool, maybeChallengeTheme interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		...
		qm.WhereIn(`theme_tag_relations.challenge_theme_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
