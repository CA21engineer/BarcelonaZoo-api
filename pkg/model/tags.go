...
func (o *Tag) ThemeTagRelations(mods ...qm.QueryMod) themeTagRelationQuery {
	...
	queryMods = append(queryMods,
		qm.Where("`theme_tag_relations`.`tag_id`=?", o.ID),
	)
...
func (tagL) LoadThemeTagRelations(ctx context.Context, e boil.ContextExecutor, singular bool, maybeTag interface{}, mods queries.Applicator) error {
	var slice []*Tag
	var object *Tag
	...
	query := NewQuery(qm.From(`theme_tag_relations`), qm.WhereIn(`theme_tag_relations.tag_id in ?`, args...))
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *Tag) AddThemeTagRelations(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*ThemeTagRelation) error {
	var err error
